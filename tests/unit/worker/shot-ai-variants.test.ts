...
describe('worker shot-ai-variants behavior', () => {
  beforeEach(() => {
    ...
    prismaMock.studioPanel.findUnique.mockResolvedValue({
      id: 'panel-1',
      panelNumber: 3,
  ...
  it('suggestions fewer than 3 -> explicit error', async () => {
    ...
    await expect(handleAnalyzeShotVariantsTask(job, payload)).rejects.toThrow('Not enough variants were generated')
  })
})
