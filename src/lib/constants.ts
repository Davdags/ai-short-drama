...
export const FIRST_LAST_FRAME_MODELS = [
  // EvoLink
  { value: 'seedance-2.0', label: 'Seedance 2.0 (F/L Frame)' },
  { value: 'seedance-1.5-pro', label: 'Seedance 1.5 Pro (F/L Frame)' },
  { value: 'kling-o3-image-to-video', label: 'Kling O3 (F/L Frame)' },
  { value: 'kling-v3-image-to-video', label: 'Kling V3 (F/L Frame)' },
  // Bailian (Ark)
  { value: 'doubao-seedance-1-5-pro-251215', label: 'Seedance 1.5 Pro (F/L Frame)' },
  { value: 'doubao-seedance-1-5-pro-251215-batch', label: 'Seedance 1.5 Pro (F/L Batch) -50%' },
  { value: 'doubao-seedance-1-0-pro-250528', label: 'Seedance 1.0 Pro (F/L Frame)' },
  { value: 'doubao-seedance-1-0-pro-250528-batch', label: 'Seedance 1.0 Pro (F/L Batch) -50%' },
  { value: 'doubao-seedance-1-0-lite-i2v-250428', label: 'Seedance 1.0 Lite (F/L Frame)' },
  { value: 'doubao-seedance-1-0-lite-i2v-250428-batch', label: 'Seedance 1.0 Lite (F/L Batch) -50%' },
  // Google
...
export const TTS_RATES = [
  ...
  { value: '+20%', label: 'Slight (1.2x)' },
  { value: '+50%', label: 'Fast (1.5x)' },
  { value: '+100%', label: 'Rapid (2.0x)' }
]
