...
export function useUpdateProjectCharacterIntroduction(projectId: string) {
    ...
    return useMutation({
        mutationFn: async ({
            ...
            return await requestJsonWithError(`/api/studio/${projectId}/character`, {
                method: 'PATCH',
    ...
    return useMutation({
        mutationFn: async ({
            ...
            const response = await requestTaskResponseWithError(
                `/api/studio/${projectId}/ai-modify-appearance`,
                {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
...
export function useAiCreateProjectCharacter(projectId: string) {
    return useMutation({
        mutationFn: async (payload: { userInstruction: string }) => {
            const response = await requestTaskResponseWithError(
                `/api/studio/${projectId}/ai-create-character`,
                {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
...
export function useExtractProjectReferenceCharacterDescription(projectId: string) {
    return useMutation({
        mutationFn: async (referenceImageUrls: string[]) => {
            const response = await requestTaskResponseWithError(
                `/api/studio/${projectId}/reference-to-character`,
                {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
    ...
    return useMutation({
        mutationFn: async (payload: {
            ...
            await requestJsonWithError(
                `/api/studio/${projectId}/character`,
                {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(payload),
...
export function useCreateProjectCharacterAppearance(projectId: string) {
    ...
    return useMutation({
        mutationFn: async (payload: {
            ...
            await requestJsonWithError(
                `/api/studio/${projectId}/character/appearance`,
                {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(payload),
...
export function useConfirmProjectCharacterSelection(projectId: string) {
    ...
    return useMutation({
        mutationFn: async ({ characterId, appearanceId }: { characterId: string; appearanceId: string }) =>
            await requestJsonWithError(
                `/api/studio/${projectId}/character/confirm-selection`,
                {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
...
export function useConfirmProjectCharacterProfile(projectId: string) {
    ...
    return useMutation({
        mutationFn: async (payload: {
            ...
            const response = await requestTaskResponseWithError(
                `/api/studio/${projectId}/character-profile/confirm`,
                {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(payload),
...
export function useBatchConfirmProjectCharacterProfiles(projectId: string) {
    ...
    return useMutation({
        mutationFn: async () => {
            const response = await requestTaskResponseWithError(
                `/api/studio/${projectId}/character-profile/batch-confirm`,
                {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                },
