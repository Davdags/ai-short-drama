...
export const EVOLINK_MODEL_PRESETS: EvolinkModelPreset[] = [
  ...
  { type: 'llm', modelId: 'gemini-3-flash-preview', name: 'Gemini 3.0 Flash' },
  { type: 'llm', modelId: 'claude-opus-5-5', name: 'Claude Opus 5.5' },
  { type: 'llm', modelId: 'claude-sonnet-5', name: 'Claude Sonnet 5' },
  ...
  { type: 'image', modelId: 'doubao-seedream-5.0-lite', name: 'Seedream 5.0 Lite' },
  ...
  { type: 'video', modelId: 'seedance-2.5', name: 'Seedance 2.5' },
