...
export const POST = apiHandler(async (
  ...
  await assertCanAffordWriting({ userId: session.user.id, projectId, stage: 'script', storyChars: content.length })
  ...
  const asyncTaskResponse = await maybeSubmitLLMTask({
    ...
    targetId: episodeId,
    routePath: `/api/studio/${projectId}/story-to-script-stream`,
    body: {
      ...body,
      displayMode: 'detail',
    },
