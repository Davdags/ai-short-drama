  ...
  return (
    <div className="h-screen flex flex-col bg-[#fafafa] overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="w-64 px-3 py-2 border border-[#e5e5e5] rounded-md bg-white text-[#171717] placeholder:text-[#a3a3a3] focus:border-black focus:outline-none transition-colors"
            />
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          <div
            ...
            className="border-2 border-dashed border-[#e5e5e5] rounded-xl bg-white p-6 cursor-pointer group flex items-center justify-center hover:border-[#d4d4d4] transition-all duration-300"
          >
            <div className="flex flex-col items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-[#171717] flex items-center justify-center group-hover:scale-110 transition-all duration-300">
          ...
          {loading ? (
            ...
            projects.map((project) => (
              <Link
                ...
                className="border border-[#e5e5e5] rounded-xl bg-white cursor-pointer relative group block hover:border-[#d4d4d4] transition-all duration-300 overflow-hidden"
              >
                <div className="p-5 relative z-10">
                  ...
                  {/* 标题 */}
                  <h3 className="text-lg font-bold text-[var(--glass-text-primary)] mb-2 line-clamp-2 pr-20 transition-colors">
                    {project.name}
                  </h3>
                  ...
                  {project.stats && (project.stats.episodes > 0 || project.stats.images > 0 || project.stats.videos > 0) ? (
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <div className="flex items-center gap-3 text-sm font-semibold text-[var(--glass-text-primary)]">
              ...
              .map((page, index, array) => (
                <span key={page} className="flex items-center">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${page === pagination.page
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
            <h2 className="text-xl font-semibold text-[#171717] mb-4">{t('createProject')}</h2>
            {modelNotConfigured && (
            ...
            <form onSubmit={handleCreateProject}>
              <div className="mb-4">
                <label htmlFor="name" className="text-sm font-medium text-[#525252] block mb-2">
                  {t('projectName')} *
                </label>
                <input
                  id="name"
                  ...
                  className="w-full px-3 py-2 border border-[#e5e5e5] rounded-md bg-white text-[#171717] placeholder:text-[#a3a3a3] focus:border-black focus:outline-none transition-colors"
              ...
              <div className="mb-6">
                <label htmlFor="description" className="text-sm font-medium text-[#525252] block mb-2">
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-[#e5e5e5] rounded-md bg-white text-[#171717] placeholder:text-[#a3a3a3] focus:border-black focus:outline-none transition-colors resize-none"
              ...
              <div className="flex justify-end space-x-3">
                <button
                  ...
                  className="px-4 py-2 rounded-lg border border-[#e5e5e5] bg-white text-[#525252] text-sm font-medium hover:bg-[#f5f5f5] transition-colors"
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg bg-[#171717] text-white text-sm font-medium hover:bg-[#262626] transition-colors disabled:opacity-50"
      ...
      {showEditModal && editingProject && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
            <h2 className="text-xl font-semibold text-[#171717] mb-4">{t('editProject')}</h2>
            <form onSubmit={handleEditProject}>
              <div className="mb-4">
                <label htmlFor="edit-name" className="text-sm font-medium text-[#525252] block mb-2">
                  {t('projectName')} *
                </label>
                <input
                  id="edit-name"
              ...
              <div className="mb-6">
                <label htmlFor="edit-description" className="text-sm font-medium text-[#525252] block mb-2">
                  {t('projectDescription')}
                </label>
                <textarea
                  id="edit-description"
