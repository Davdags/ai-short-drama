...
import type { PromptField } from '@/lib/studio/stages/video-stage-runtime/useVideoPromptState'
  ...
  return (
    <>
      <div className={`grid gap-4 ${getAspectRatioConfig(videoRatio).isVertical
        ? 'grid-cols-1 min-[480px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'
