...
export const PRESET_MODELS: PresetModel[] = [
    ...
    { modelId: 'qwen3-tts-vd-2026-01-26', name: 'Qwen3 TTS', type: 'audio', provider: 'evolink' },
    { modelId: 'qwen-voice-design', name: 'Qwen Voice Design', type: 'audio', provider: 'evolink' },
    // 口型同步模型
    ...
    { modelId: 'videoretalk', name: 'VideoRetalk Lip Sync', type: 'lipsync', provider: 'evolink' },
    ...
    { modelId: 'seedance-2.0', name: 'Seedance 2.0', type: 'video', provider: 'evolink' },
