...
ARG CACHE_BUST=0
# Public site address, baked into page metadata / sitemap at build time (empty = localhost fallback)
...
ENV NEXT_PUBLIC_TWITTER_PIXEL_ID=$NEXT_PUBLIC_TWITTER_PIXEL_ID
...
ENV NEXT_PUBLIC_GOOGLE_ADS_PURCHASE_LABEL=$NEXT_PUBLIC_GOOGLE_ADS_PURCHASE_LABEL
